---
title: KPI for SDG projects 
language: en
permalink: /sdg-impact-kpi/
layout: page
---
...
<iframe width="600" height="450" src="https://lookerstudio.google.com/embed/reporting/dcb24575-b0e3-43ae-a780-9acc1d4c47ea/page/jmUKF" frameborder="0" style="border:0" allowfullscreen sandbox="allow-storage-access-by-user-activation allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox"></iframe>
...
#### [SDG 7]({{ site.baseurl }}/7/) can be a key accelerator for the Central Asian region, as:
...
#### [SDG 9]({{ site.baseurl }}/9/) could be another interesting candidate for SDG acceleration
It has been identified to have challenges for implementation according to data from UN Stats, it is relatively underfunded in the Central Asian project portfolio (around 1% of the budget), and so far it has a 100% KPI implementation success rate. The SDG 9 is closely related to the [Middle Corridor initiative]({{ site.baseurl }}/middle-corridor/), which show great potential for economic spillover effects from infrastruture investments

#### SDG 10 ({{ site.baseurl }}/10/) could also be good candidate in which to maintain investment
